...
import allmaker_partners.adamstore.co.kr.databinding.DlgChoiceLawTypeSubBinding;
import allmaker_partners.adamstore.co.kr.util.HoUtils;

public class DlgChoiceLawTypeSub extends Activity implements View.OnClickListener {
    DlgChoiceLawTypeSubBinding binding;
    Activity act;
    String type;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding= DataBindingUtil.setContentView(this, R.layout.dlg_choice_law_type_sub);
        setLayout();
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_ok:
                if(HoUtils.isNull(type)){
                    Toast.makeText(act, "검색대상을 선택해 주세요.", Toast.LENGTH_SHORT).show();
                }else{
