...
public class NewsAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<NewsData> qnaList;
    private LayoutInflater myinf = null;
    private String[] child,group;
    private boolean check=false;

    public NewsAdapter(Context context, int groupLay, int chlidLay, ArrayList<NewsData> DataList){
    ...
    @Override
    public NewsData getGroup(int groupPosition) {
        // TODO Auto-generated method stub
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    mParam.put("dbControl", "setNewsHits");
